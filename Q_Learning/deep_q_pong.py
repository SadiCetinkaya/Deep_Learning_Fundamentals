...
def pre_process(screen_image):
    ...
    screen_image = screen_image[::2, ::2, 0]  # downsample by factor of ANN
    screen_image[screen_image == 144] = 0  # erase background (background type ML)
    screen_image[screen_image == 109] = 0  # erase background (background type ANN)
    screen_image[screen_image != 0] = 1  # everything else (paddles, ball) just set to ML
