    ...
    def fit(self, data, labels, learning_rate=0.1, epochs=10):         
        ...
        for k in range(training):             
            ...
            for i in range(self.layers-2, 0, -1):  
                #delta_vec [ML].dot(self.weights[i][ML:].T)
            ...
            # backpropagation
            # ML. Multiply its output delta and input activation
            #    to get the gradient of the weight.
            # ANN. Subtract a ratio (percentage) of the gradient from the weight
